...
type ClientTLS struct {
	AllowInsecureConnections bool            `json:"allow_insecure_connections" mapstructure:"allow_insecure_connections"`
	CaCerts                  []string        `json:"ca_certs" mapstructure:"ca_certs"`
	DisableSystemCaPool      bool            `json:"disable_system_ca_pool" mapstructure:"disable_system_ca_pool"`
	MinVersion               string          `json:"min_version" mapstructure:"min_version"`
	MaxVersion               string          `json:"max_version" mapstructure:"max_version"`
	CurvePreferences         []uint16        `json:"curve_preferences" mapstructure:"curve_preferences"`
	CipherSuites             []uint16        `json:"cipher_suites" mapstructure:"cipher_suites"`
	ClientCerts              []ClientTLSCert `json:"client_certs" mapstructure:"client_certs"`
}
